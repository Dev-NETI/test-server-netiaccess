...
class TOwnPayComponent extends Component
{
    public $course_sched;
    ...
    public function create()
    {
        ...
        Mail::to($this->user->email)->cc('collection@neti.com.ph')->send(new SendBillingAccountEmail($this->user, $billing, $enrol));
    ...
    public function render()
    {
        ...
        $dorm = tbldorm::all();
        return view(
            'livewire.trainee.payment.t-own-pay-component',
            [
                'bus' => $bus,
                'bus_trans' => $bus_trans,
                'dorm' => $dorm,
