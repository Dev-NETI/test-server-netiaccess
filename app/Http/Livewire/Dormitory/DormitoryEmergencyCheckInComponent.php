...
class DormitoryEmergencyCheckInComponent extends Component
{
    use ConsoleLog;
    ...
    public function searchcheckin()
    {
        ...
        try {
            $query = "select
						  ...
						  d.company,
						  e.paymentmode,
						  f.scheduleid ,f.startdateformat,f.enddateformat,
						  x.enroledid
						  from
						  tbltraineeaccount as a inner join tblenroled as x
						  on a.traineeid=x.traineeid
						  ...
						  x.pendingid = 0 and x.deletedid = 0 and x.dormid = 0 and f.startdateformat BETWEEN '" . $datefrom . "' and '" . $dateto . "'";
    ...
    public function render()
    {
        ...
        return view('livewire.dormitory.dormitory-emergency-check-in-component')->layout('layouts.admin.abase');
    }
}
