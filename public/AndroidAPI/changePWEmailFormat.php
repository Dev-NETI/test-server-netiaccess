...
<p style="margin: 0; font-size: 16px; text-align: left; mso-line-height-alt: 24px;">We have received a request to change the password for your account. To ensure the security of your account, please use the following change password pin to proceed:
<br><br>
Change Password Pin: [XXXXXX]: <?php echo $changepasspin; ?>
<br><br>
