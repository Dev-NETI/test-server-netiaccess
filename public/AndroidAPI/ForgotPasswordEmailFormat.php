...
<p style="margin: 0; font-size: 16px; text-align: left; mso-line-height-alt: 24px;">We noticed that you've requested to reset the password for your account. To ensure the security of your account, we've generated a verification code that you'll need to proceed with the password reset process.
<br><br>
Verification Code: <?php echo $otp; ?><br><br>
If you didn't request a password reset, please disregard this email. Your account's security is important to us, and you should change your password if you suspect any unauthorized activity.
<br><br>
Best regards,
</div>
</div>
