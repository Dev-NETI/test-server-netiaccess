...
<p style="margin: 0; font-size: 16px; text-align: left; mso-line-height-alt: 24px;">In our ongoing commitment to safeguard your account's security, we have implemented an additional layer of protection through a One-Time PIN (OTP) system.
<br><br>
Your OTP for secure access is: <?php echo $otp; ?>
<br><br>
Please enter this One Time Pin on the verification page to confirm your account. Please note that this One Time Pin is valid for a limited time period and should not be shared with anyone else. If you did not initiate this verification process, please ignore this email.</p>
<br><br>
