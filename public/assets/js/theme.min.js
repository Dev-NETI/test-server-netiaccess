...
!(function () {
    ...
    if (
        ...
        var n = document.getElementById("liveAlertPlaceholder"),
            o = document.getElementById("liveAlertBtn");
        o &&
    ...
    if ($(".glightboxGallery").length)
        GLightbox({ selector: ".glightboxGallery" });
})(),
    (function () {
        if ($('.theme-switch input[type="checkbox"]').length) {
    ...
    (function () {
        if ($("#changelog").length) {
            document.getElementById("changelog").innerHTML = "v1.1.2";
        }
    })();
