                                ...
                                <form class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-md-4">
                                            ...
                                            <input type="text" id="f_name" class="form-control" name="f_name" placeholder="Enter firstname .." wire:model="f_name" required>
                                            @error('f_name')
                                        ...
                                        <div class="mb-3 col-md-4">
                                            ...
                                            <input type="text" id="m_name" class="form-control" name="m_name" placeholder="Enter middlename .." wire:model="m_name" required>
                                            @error('m_name')
                                            <p class="text-danger">{{$message}}</p>
                                            @enderror
                                        </div>
                                        <div class="mb-3 col-md-4">
                                            ...
                                            <input type="text" id="l_name" class="form-control" name="l_name" placeholder="Enter lastname .." wire:model="l_name" required>
                                            @error('l_name')
                                            <p class="text-danger">{{$message}}</p>
                                            @enderror
                                        </div>
                                        <div class="mb-3 col-md-4">
                                            ...
                                            <input type="text" id="suffix" class="form-control" name="suffix" placeholder="Enter suffix e.g. jr, sr and etc .." wire:model="suffix">
                                            @error('suffix')
                                            <p class="text-danger">{{$message}}</p>
                                            @enderror
                                        </div>
                                        <div class="mb-3 col-md-4">
                                            ...
                                            <input type="date" id="birth_day" class="form-control" name="birth_day" wire:model="birth_day" required>
                                            @error('birth_day')
                                            <p class="text-danger">{{$message}}</p>
                                            @enderror
                                        </div>
                                        <div class="mb-3 col-md-4">
                                            ...
                                            <input class="form-control" name="birth_place" id="birth_place" cols="30" rows="2" wire:model="birth_place" placeholder="Enter your birthplace .."></input>
                                            @error('birth_place')
                                            <p class="text-danger">{{$message}}</p>
                                            @enderror
                                        </div>
                                        <div class="mb-3 col-md-3">
                                            ...
                                            <select class="form-control" name="" id="gender" wire:model="selectedGender">
                                        ...
                                        <div class="mb-3 col-md-3">
                                            ...
                                            <select class="form-control" name="" id="nationality" wire:model="selectedNationality">
                                        ...
                                        <div class="mb-3 col-md-3">
                                            ...
                                            <input class="form-control" name="srn_num" id="srn_num" cols="30" rows="2" wire:model="srn_num" placeholder="Enter your SRN number .."></input>
                                            @error('srn_num')
                                            <p class="text-danger">{{$message}}</p>
                                            @enderror
                                        </div>
                                        <div class="mb-3 col-md-3">
                                            <label for="text" class="form-label">TIN Number <i><small>(if
                                                        applicable)</small></i></label>
                                            <input class="form-control" name="tin_num" id="tin_num" cols="30" rows="2" wire:model="tin_num" placeholder="Enter your TIN number .."></input>
                                            @error('tin_num')
                                            <p class="text-danger">{{$message}}</p>
                                            @enderror
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            @else
                                            <small>YOUR CURRENT ADDRESS: </small>
                                            <h4 class="text-uppercase"> <i>{{optional($trainee)->street}} ,
                                                    {{optional($trainee->brgy)->brgyDesc}}, {{optional($trainee->city)->citymunDesc}},
                                                    {{optional($trainee->prov)->provDesc}}, {{optional($trainee->reg)->regDesc}},
                                                    {{optional($trainee)->postal}}</i></h4>
                                            @endif
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="mb-3 col-md-4">
                                                ...
                                                <select class="form-control" id="selectedRegion" wire:model="selectedRegion" wire:loading.attr="" wire:target="selectedRegion">
                                            ...
                                            <div class="mb-3 col-md-4">
                                                ...
                                                <select class="form-control" name="" id="selectedProvince" wire:model="selectedProvince" wire:loading.attr="" wire:target="selectedProvince">
                                            ...
                                            <div class="mb-3 col-md-4">
                                                ...
                                                <select class="form-control" name="" id="selectedCity" wire:model="selectedCity" wire:loading.attr="" wire:target="selectedCity">
                                            ...
                                            <div class="mb-3 col-md-4">
                                                ...
                                                <select class="form-control" name="" id="selectedBrgy" wire:model="selectedBrgy" wire:loading.attr="" wire:target="selectedBrgy">
                                            ...
                                            <div class="mb-3 col-md-4">
                                                ...
                                                <input class="form-control" id="street" type="text" placeholder="Enter street/house no./etc." wire:model="street">
                                                @error('street')
                                                <p class="text-danger">{{$message}}</p>
                                                @enderror
                                            </div>
                                            <div class="mb-3 col-md-4">
                                                ...
                                                <input class="form-control" id="postal" type="text" placeholder="Enter postal code .. " wire:model="postal">
                                                @error('postal')
                                                <p class="text-danger">{{$message}}</p>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="mb-3 col-md-4">
                                                ...
                                                <select class="form-control" name="" id="s_exp_rank" wire:model="s_exp_rank">
                                            ...
                                            <div class="mb-3 col-md-4">
                                                ...
                                                <select class="form-control" name="" id="s_company" wire:model="s_company">
                                            ...
                                            <div class="mb-3 col-md-4">
                                                ...
                                                <select class="form-control" name="" id="s_fleet" wire:model="s_fleet">
