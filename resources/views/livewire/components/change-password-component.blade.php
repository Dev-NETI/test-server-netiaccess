                        ...
                        <div class="navbar-nav flex-column">
                            ...
                            <ul class="list-unstyled ms-n2 mb-0">
                                ...
                                <li class="nav-item active">
                                    <a class="nav-link" href="#"><i class="fe fe-user nav-icon"></i>View Security</a>
                                </li>
                                <li class="nav-item">
            ...
            <div class="col-lg-9 col-md-8 col-12 mb-3">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <span class="text-danger">Please be careful updating your email. Checking for typo is a MUST!</span>
                        <p>
