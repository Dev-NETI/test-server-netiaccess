                                        ...
                                        <tr wire:key="enroll-{{ $enroll->enroledid }}">
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    {{-- <h5 class="mb-0" style="text-transform: uppercase;">{{$enroll->trainee->f_name}}</h5> --}}
                                                    @if ($enroll->trainee)
                                            ...
                                            <td>
                                                <span class="dropdown dropstart">
                                                    ...
                                                    <span class="dropdown-menu" aria-labelledby="courseDropdown1">
                                                        ...
                                                        <a class="dropdown-item" href="{{ route('c.viewadmission', ['enrol_id' => $enroll->enroledid]) }}" target="_blank">
