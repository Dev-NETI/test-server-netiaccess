<section class="container-fluid p-4">
    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12 col-12">
            ...
            <div>
                ...
                <button type="button" class="btn btn-primary mb-3" data-bs-toggle="modal"
                    data-bs-target="#addTraineeModalPJ"> Add PJMCC/JISS Trainee</button>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div id="form-container" class="row">
                                    <div class="modal-body">
                                        <form wire:submit.prevent="createTrainee">
                                            @csrf
                                            <div class="row">
                                                <div class="mb-3 col-md-4">
                                                    <label class="form-label">Firstname</label>
                                                    <input type="text" id="f_name" class="form-control"
                                                        placeholder="Enter firstname .." wire:model.defer="f_name"
                                                        required>
                                                </div>
                                                <div class="mb-3 col-md-4">
                                                    <label class="form-label">Middlename</label>
                                                    <input type="text" id="m_name" class="form-control"
                                                        placeholder="Enter middlename .." wire:model.defer="m_name"
                                                        required>
                                                </div>
                                                <div class="mb-3 col-md-4">
                                                    <label class="form-label">Lastname <text
                                                            style="color:red">*</text></label>
                                                    <input type="text" id="l_name" class="form-control"
                                                        placeholder="Enter lastname .." wire:model.defer="l_name"
                                                        required>
                                                ...
                                                <div class="mb-3 col-md-4">
                                                    ...
                                                    <input type="text" id="suffix" class="form-control"
                                                        placeholder="Enter suffix e.g. jr, sr and etc .."
                                                        wire:model.defer="suffix">

                                                </div>
                                                <div class="mb-3 col-md-4">
                                                    <label class="form-label">Birthday <text
                                                            style="color:red">*</text></label>
                                                    <input type="date" id="birth_day" class="form-control"
                                                        wire:model.defer="birth_day" required>
                                                </div>

                                                <div class="mb-3 col-md-4">
                                                    <label for="text" class="form-label">Birthplace <text
                                                            style="color:red">*</text></label>
                                                    <input class="form-control" name="birth_place" id="birth_place"
                                                        cols="30" rows="2" wire:model.defer="birth_place"
                                                        placeholder="Enter your birthplace .."></input>


                                                </div>
                                                <div class="mb-3 col-md-3">
                                                    <label class="form-label">Gender <text
                                                            style="color:red">*</text></label>
                                                    <select class="form-select" name="" id="gender"
                                                        wire:model.defer="selectedGender">
                                                ...
                                                <div class="mb-3 col-md-3">
                                                    ...
                                                    <select class="form-select" name="" id="Nationality"
                                                        wire:model.defer="selectedNationality">
                                                ...
                                                <div class="mb-3 col-md-3">
                                                    ...
                                                    <input class="form-control" id="srn_num" cols="30" rows="2"
                                                        wire:model.defer="srn_num"
                                                        placeholder="Enter your SRN number .."></input>

                                                </div>
                                                <div class="mb-3 col-md-3">
                                                    <label for="text" class="form-label">TIN Number <i><small>(if
                                                                applicable)</small></i></label>
                                                    <input class="form-control" id="tin_num" cols="30" rows="2"
                                                        wire:model.defer="tin_num"
                                                        placeholder="Enter your TIN number .."></input>
                                                    ...
                                                    <div class="mb-3 col-md-12">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox" value=""
                                                                id="invalidCheck" wire:model="showAnotherForm" required>
                                                ...
                                                <div class="mb-3 col-md-4">
                                                    ...
                                                    <select class="form-select" name="" id="reg"
                                                ...
                                                <div class="mb-3 col-md-4">
                                                    ...
                                                    <select class="form-select" name="" id="prov"
                                                ...
                                                <div class="mb-3 col-md-4">
                                                    ...
                                                    <select class="form-select" name="" id="brgy"
                                                        wire:model="selectedBrgy">
                                                ...
                                                <div class="mb-3 col-md-4">
                                                    ...
                                                    <input class="form-control" type="text"
                                                        placeholder="Enter postal code .. " wire:model.defer="postal">
                                                    @error('postal')
                                                    <p class="text-danger">{{ $message }}</p>
                                                    @enderror
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="mb-3 col-md-4">
                                                        <label class="form-label">Experienced Rank <text
                                                                style="color:red">*</text></label>
                                                        <select class="form-select" id="rank"
                                                            wire:model.defer="s_exp_rank">
                                                    ...
                                                    <div class="mb-3 col-md-4">
                                                        <label class="form-label">Company <text
                                                                style="color:red">*</text></label>
                                                        <select class="form-select" id="company" wire:model="s_company">
                                                    ...
                                                    @if ($s_company == 1)
                                                    <div class="mb-3 col-md-4">
                                                        <label class="form-label">Fleet <text
                                                                style="color:red">*</text></label>
                                                        <select class="form-select" id="fleet"
                                                            wire:model.defer="s_fleet">
                                                ...
                                                <div class="row">
                                                    <div class="mb-3 col-md-6">
                                                        <label class="form-label">Create Password <text
                                                                style="color:red">*</text></label>
                                                        <input type="password" class="form-control"
                                                            placeholder="********" wire:model.defer="i_password">
                                                    </div>
                                                    <div class="mb-3 col-md-6">
                                                        <label class="form-label">Re-Type Password <text
                                                                style="color:red">*</text></label>
                                                        <input type="password" class="form-control"
                                                            placeholder="********" wire:model.defer="c_password">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="button" class="btn btn-primary"
                                                        data-bs-target="#add-trainee-modal"
                                                        wire:click.prevent="createTrainee">Add</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                ...
                <div wire:ignore.self class="modal fade" id="addTraineeModalPJ" tabindex="-1">
                    <div class="modal-dialog modal-xl ">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">Add Trainee</h5>
                            ...
                            <div class="modal-body">
                                <div id="form-container" class="row">
                                    <div class="modal-body">
                                        <form wire:submit.prevent="createTraineePj">
                                            @csrf
                                            <div class="row">
                                                <div class="mb-3 col-md-4">
                                                ...
                                                <div class="mb-3 col-md-4">
                                                    <label class="form-label">Middlename</label>
                                                    <input type="text" id="m_name" class="form-control" name="m_name"
                                                        placeholder="Enter middlename .." wire:model.defer="m_name"
                                                        required>
                                                </div>
                                                <div class="mb-3 col-md-4">
                                                ...
                                                <div class="mb-3 col-md-4">
                                                    <label class="form-label">Nationality</label>
                                                    <select class="form-select" wire:model.defer="selectedNationality"
                                                        name="" id="">
                                                        <option value="">Select Nationality</option>
                                                        @foreach ($nationalities as $item)
                                                        <option value="{{$item->nationalityid}}">{{$item->nationality}}
                                                        </option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary"
                                                        data-bs-dismiss="modal">Close</button>
                                                    <button type="button" class="btn btn-primary"
                                                        data-bs-target="#add-trainee-modal-pj"
                                                        wire:click.prevent="createTraineePj">Add</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                            ...
                            <div class="card-header">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 float-end">
                                        <input type="text" placeholder="search in name, rank or email .."
                                            wire:model.debounce.500ms="search" class="form-control">
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <tr class="mt-1 mb-2">
                                            <td style="min-width: 10em;">
                                                <div class="btn-group" role="group">
                                                    <button id="" type="button" class="btn btn-info dropdown-toggle"
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="">
                                                        <button class="dropdown-item"
                                                            wire:click="getTrainee({{ $t_account->traineeid }})"
                                                            data-bs-toggle="modal" data-bs-target="#exampleModal-2"><i
                                                                class="bi bi-plus"
                                                                style="font-size: 1em;"></i>&nbsp;Enroll
                                                            Crew</button>
                                                        <a class="dropdown-item"
                                                            href="{{ route('a.editprofile', ['traineeid' => $t_account->traineeid]) }}"><i
                                                                class="bi bi-person-check"></i>&nbsp;Edit
                                                            Profile</a>
                                                        {{-- <a class="dropdown-item" href="#"
                                                            wire:click="showModalPicture({{$t_account->traineeid}})"><i
                                                                class="bi bi-camera-fill"></i>&nbsp;Add/Replace
                                                            Picture</a> --}}
                                                        <button class="dropdown-item"
                                                            wire:click.prevent="confirmdelete({{$t_account->traineeid}})"><i
                                                                class="bi bi-trash"
                                                                style="font-size: 1em;"></i>&nbsp;Delete
                                                            Account</button>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                ...
                                                <img src="{{asset('storage/traineepic/'.$t_account->imagepath)}}"
                                                    width="50" alt="avatar">
                                                @else
                                                <img src="{{ asset('assets/images/avatar/avatar.jpg') }}" width="50"
                                                    alt="avatar">
                                                @endif
                                            </td>
                                            @if ($t_account)
                                            ...
                                            <td class="text-danger">Not Specified</td>
                                            @endif
                                            @if ($t_account->contact_num)
                                            <td>{{ strtoupper($t_account->contact_num) }}</td>
                                            @else
                                            <td class="text-danger">Not Specified</td>
                                            @endif
    ...
    <!-- Modal -->
    <div class="modal fade" id="showUploadModalPicture" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
