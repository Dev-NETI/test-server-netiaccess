                            ...
                            <div class="card-body">
                                <div class="d-xl-flex justify-content-between align-items-center">
                                    <div class="d-flex align-items-center mb-3 mb-xl-0">
                                        ...
                                        <!-- sidebar -->
                                        <div class="ms-3 lh-1">
                                            <h5 class="mb-1"> <span class="text-uppercase"> <i>{{$certificate->trainee->formal_name()}}</i> </span> | This certificate are printed {{date("F j, Y", strtotime($certificate->created_at))}}</h5>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div>
                                            <small class="text-muted">{{ date("F j, Y, g:i A", strtotime($certificate->created_at)) }}</small>
                                        </div>
                                        <div class="ms-2">
