        ...
        <div class="col-lg-12 col-md-12 col-12">
            ...
            <div class="border-bottom pb-3 mb-3 d-md-flex align-items-center justify-content-between">
                <div class="mb-3 mb-md-0">
                    <h1 class="mb-1 h2 fw-bold">Certificate Invalid </h1>
                </div>
            </div>
        </div>
    </div>
                                ...
                                <table class="table mb-0 text-nowrap table-centered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr wire:key="schedule-{{$training_schedule->scheduleid}}">
                                            ...
                                            <td>
                                                @if($training_schedule->pending_invalid_count > 0)
                                                <span class="badge-dot bg-info me-1 d-inline-block align-middle"></span><small>Invalid Certificate <span style="color:red;"><i>({{$training_schedule->pending_invalid_count}} remaining trainee)</i></span></small>
                                                @elseif($training_schedule->pending_invalid_count == 0)
                                ...
                                <div class="modal-dialog modal-fullscreen" role="document">
                                    <div class="modal-content">
                                        <div class="modal-body">
                                            ...
                                            @if($scheduleid)
                                            <livewire:admin.approval.invalid.a-certificate-invalid-table-component :training_id="$scheduleid" :key="$scheduleid" />
                                            @else
