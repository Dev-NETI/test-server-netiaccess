        ...
        <div class="col-lg-12 col-md-12 col-12">
            ...
            <div class="border-bottom pb-3 mb-3 d-md-flex align-items-center justify-content-between">
                <div class="mb-3 mb-md-0">
                    <h1 class="mb-1 h2 fw-bold">Certificate Approval </h1>
                </div>
            </div>
        </div>
    </div>
                                ...
                                <table class="table mb-0 text-nowrap table-centered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr wire:key="schedule-{{$training_schedule->scheduleid}}">
                                            ...
                                            <td>
                                                @if($training_schedule->pending_approval_count > 0)
                                                <span class="badge-dot bg-info me-1 d-inline-block align-middle"></span><small>Waiting for Approval <span style="color:red;"><i>({{$training_schedule->pending_approval_count}} remaining trainee)</i></span></small>
                                                @elseif($training_schedule->pending_approval_count == 0)
                                ...
                                <div class="modal-dialog modal-fullscreen" role="document">
                                    <div class="modal-content">
                                        <div class="modal-body">
                                            @if($scheduleid)
                                            <livewire:admin.approval.a-certificate-approval-table-component :training_id="$scheduleid" :key="$scheduleid" />
                                            @else
                                            <p>No schedule selected.</p>
                                            @endif
                                        </div>
                                        <div class="modal-footer">
                                            <button wire:click.prevent="closeModal" type="button" class="btn btn-secondary">Close</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
