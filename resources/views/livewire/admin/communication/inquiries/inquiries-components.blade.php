<section class="container-fluid p-4">
                ...
                <div class="card-header p-0">
                    <div>
                        ...
                        <ul class="nav nav-lb-tab  border-bottom-0 " id="tab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="all-tab" data-bs-toggle="pill" href="#all" role="tab" aria-controls="courses" aria-selected="true">All</a>
                            </li>
                            {{-- <li class="nav-item">
                        ...
                        <div class="tab-pane fade show active" id="all" role="tabpanel" aria-labelledby="all-tab">
                            ...
                            <div class="p-4 row">
                                ...
                                <form class="d-flex align-items-center col-12 col-md-12 col-lg-12">
                                    ...
                                    <input type="search" class="form-control ps-6" wire:model.debounce.500ms="search" placeholder="Search Inquiry">
                                </form>
                            </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @if ($email_inquiries->is_answered == 1 )
                                                <button class="btn btn-info" data-bs-toggle="modal" data-bs-target="#viewdetailsmodal" wire:click="viewdetails({{ $email_inquiries->emailinquiryid }})">
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        ...
                                                        <a class="dropdown-item" href="{{ route('a.inquiry-view', ['hash_id' => $email_inquiries->hash_id]) }}">
                                                        ...
                                                        <a href="https://mail.google.com/mail/?view=cm&fs=1&to={{ $email_inquiries->email }}&cc=bod@neti.com.ph,prpd@neti.com.ph,noc@neti.com.ph" target="_blank" class="dropdown-item">
                                                            <i class="fe fe-send dropdown-item-icon"></i> Reply
                                                        </a>
                                                        ...
                                                        <a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#updatestatus" wire:click="statusedit({{ $email_inquiries->emailinquiryid }})">
                                                            <i class="fe fe-eye dropdown-item-icon"></i>Update Status
                                                        </a>
                                                        <button class="dropdown-item" wire:click.prevent="delete_inquiry({{ $email_inquiries->emailinquiryid }})"><i class="fe fe-trash dropdown-item-icon"></i>Delete
                                                        </button>
                                                    </div>
                                                </div>
                                                ...
                                                <a href="#" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#composeMailModal"><i class="fe fe-send dropdown-item-icon"></i>
                                                    Reply
                                                </a>
                                                <a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#updatestatus" wire:click="statusedit({{ $email_inquiries->emailinquiryid }})">
                                            ...
                                            <td>
                                                ...
                                                <span class="text-muted"> <i class="mdi mdi-email-open-outline"></i>{{$email_inquiries->email}}</span>
                                                <p>
                                                    <span class="text-muted"><i class="mdi mdi-cellphone-basic"></i>{{$email_inquiries->mobile}}</span>

                                            </td>

                                            <td>
                                                {{$email_inquiries->inquirytype->inquirytype}}
                                                <textarea class="form-control" id="textarea-input" rows="2" disabled>{{$email_inquiries->inquiry_text}}</textarea>
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                Open
                                                @else
                                                <span class="badge-dot bg-primary me-1 d-inline-block align-middle"></span>
                                                Closed
                                                @endif
                                            </td>
    ...
    <!-- Edit Course Modal -->
    <div wire:ignore.self class="modal fade" id="viewdetailsmodal" tabindex="-1" role="dialog" aria-labelledby="viewdetailsmodal" aria-hidden="true">
                    ...
                    <form id="updatecourse" wire:submit.prevent="updatecourse">
                        <div class="row">
                            <div class="mb-3 col-6">
                                ...
                                <input type="text" wire:model.defer="viewname" class="form-control" disabled>
                            </div>
                            ...
                            <div class="mb-3 col-6">
                                ...
                                <input type="text" wire:model.defer="viewemail" class="form-control" disabled>
                            </div>

                            <div class="mb-3 col-6">
                                <label class="form-label">Number </label>
                                <input type="text" wire:model.defer="viewnumber" class="form-control" disabled>
                            </div>

                            <div class="mb-3 col-6">
                                <label class="form-label">Inquiry Type</label>
                                <input type="text" wire:model.defer="viewinquirytype" class="form-control" disabled>
                            </div>
                            ...
                            <div class="mb-3 col-12">
                                ...
                                <textarea class="form-control" id="exampleFormControlTextarea1" wire:model.defer="viewinquiry" rows="3" disabled></textarea>
                            ...
                            <div class="mb-3 col-6">
                                ...
                                @if ($viewstatus == 1)
                                <h1> <span class="badge bg-success">Resolved</span> </h1>
                                @else
                                <h1> <label class="form-label">Unresolved</label> </h1>
                                @endif
                            </div>

                            <div class="mb-3 col-6">
                                <label class="form-label">Answered By</label>
                                <input type="text-area" wire:model.defer="viewansweredby" class="form-control" disabled>
                            </div>
                            ...
                            <div class="col-12">
                                <button type="button" class="btn btn-primary ms-2" data-bs-dismiss="modal">Close</button>
                            </div>
                        </div>
                    </form>
                </div>
